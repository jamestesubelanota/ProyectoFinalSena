...
public class GestionAgendarView implements Serializable{
    ...
    private Agendar editarAgenda  = new Agendar();
    ...
    public Agendar getEditarAgenda() {
        return editarAgenda;
    }

    public void setEditarAgenda(Agendar editarAgenda) {
